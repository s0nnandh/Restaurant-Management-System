...
DROP SEQUENCE IF EXISTS public.area_seq CASCADE;
DROP SEQUENCE IF EXISTS public.table_seq CASCADE;
DROP SEQUENCE IF EXISTS public.item_seq CASCADE;
DROP SEQUENCE IF EXISTS public.ingredient_seq CASCADE;
